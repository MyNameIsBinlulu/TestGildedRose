...
import baiTap.Printer;
import baiTap.TexttestFixture;
import org.junit.jupiter.api.Assertions;
import org.junit.jupiter.api.Test;

class GildedRoseTest {
    @Test
    void TestOver100Days() {
        var expected = """
                OMGHAI!
                -------- day 0 --------
                name, sellIn, quality
        ...
        TexttestFixture.printer = mockPrinter;
        TexttestFixture.Days = 100;
        TexttestFixture.main(new String[0]);
        Assertions.assertEquals(expected, mockPrinter.GetPrintedString());
    }

    static class MockPrinter implements Printer {
